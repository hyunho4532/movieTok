...
export function LoginDialog(isOpen: any) {
    ...
    return (
        <Dialog open={isOpen} onClose={() => headerItemClose(isOpen)} TransitionComponent={LoginDialogTransition} keepMounted>
            <DialogFix>
                ...
                <DialogAuthLogins>
                    ...
                    <DialogAuthLogin>
                        <Card className="w-[340px] h-[60px] flex">
                            <DialogAuthLoginImage src="src\assets\kakao_logo.png" />
